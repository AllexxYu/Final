...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЕстьРезультатПроведенияДокументаПродажаРавный(Парам01)","ЕстьРезультатПроведенияДокументаПродажаРавный","И  есть результат проведения документа Продажа, равный ""Товара хватает (сообщение документа)""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"СообщениеРавно(Парам01)","СообщениеРавно","Тогда Сообщение равно ""Товара хватает""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЕстьРезультат1ПроведенияДокументаПродажаРавный(Парам01)","ЕстьРезультат1ПроведенияДокументаПродажаРавный","И  есть результат1 проведения документа Продажа, равный ""Не хватает товара (сообщение документа) """);
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"Сообщение1Равно(Парам01)","Сообщение1Равно","Тогда Сообщение1 равно ""Не хватает товара""");
Возврат ВсеТесты;
КонецФункции
...
//@ЕстьРезультатПроведенияДокументаПродажаРавный(Парам01)
Процедура ЕстьРезультатПроведенияДокументаПродажаРавный(Парам01) Экспорт
	ТекстСообщения = ЕстьРезультатПроведенияДокументаПродажаРавныйСервер() ;
	КонтекстСохраняемый.Вставить("Сообщение",ТекстСообщения);
...
//@ЕстьРезультат1ПроведенияДокументаПродажаРавный(Парам01)
Процедура ЕстьРезультат1ПроведенияДокументаПродажаРавный(Парам01) Экспорт
	ТекстСообщения = ЕстьРезультатПроведенияДокументаПродажаРавныйСервер() ;
	КонтекстСохраняемый.Вставить("Сообщение",ТекстСообщения);
	//Ванесса.ПосмотретьЗначение(ТекстСообщения,Истина);
КонецПроцедуры
...
//@СообщениеРавно(Парам01)
Процедура СообщениеРавно(ОжидаемыйРезультат) Экспорт
 	Ванесса.ПосмотретьЗначение(ОжидаемыйРезультат,Истина);
	Если КонтекстСохраняемый.Сообщение = ОжидаемыйРезультат Тогда
		ВызватьИсключение "Товара хватает (сообщение фичи Сценарий 1)";
	//Иначе
	//	ВызватьИсключение "Не хватает товара (сообщение фичи Сценарий 1)";
	КонецЕсли;
КонецПроцедуры

&НаКлиенте
//Тогда Сообщение1 равно "Не хватает товара"
//@Сообщение1Равно(Парам01)
Процедура Сообщение1Равно(ОжидаемыйРезультат) Экспорт
 	Ванесса.ПосмотретьЗначение(ОжидаемыйРезультат,Истина);
	Если КонтекстСохраняемый.Сообщение = ОжидаемыйРезультат Тогда
		ВызватьИсключение "Не хватает товара (сообщение фичи Сценарий 2)";
	//Иначе
	//	ВызватьИсключение "Товара хватает (сообщение фичи Сценарий 2)";
	КонецЕсли;
КонецПроцедуры
